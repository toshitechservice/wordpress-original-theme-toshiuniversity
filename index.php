...
<head>
  <title>toshi university</title>
  <meta charset="utf-8" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="description" content="toshi university" />
        ...
        <div class="">
          <nav class="navbar navbar-expand-lg">
            <div class="logo_container">
              <div class="logo_text">
                <a href="index.html">
                  <img src="images/logo_slide.png" />
                  <span>Toshi University</span>
                </a>
              </div>
            </div>
              ...
              <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="title-slide">
                    <p>Toshi University</p>
                  </div>
                  <div class="content-slide">
                    <p>
                      TOSHI大学の理念には「プログラミングを通して、
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_section footer_about">
                  <div class="footer_logo_container">
                    ...
                    <a href="">
                      <div class="footer_logo_text">Toshi University</div>
                    </a>
                  </div>
                  <div class="footer_contact_info">
                    <div>〒556-0002</div>
                    <div>大阪府大阪市浪速区恵美須東1丁目18-6</div>
                    <ul>
                      <li><span>TEL: </span>01-2222-33</li>
                ...
                <div class="footer_section footer_links">
                  <div class="footer_links_container">
                    <ul>
                      ...
                      <li><a href="about_us.html">とし大学について</a></li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <div class="row copyright_row">
        <div class="col">
          <div class="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
            <div class="cr_text">
              Copyright &copy; Toshi University All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
